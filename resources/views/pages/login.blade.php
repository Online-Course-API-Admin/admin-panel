...
<body class="layout-login-centered-boxed">
    <div class="layout-login-centered-boxed__form">
        <div class="d-flex flex-column justify-content-center align-items-center mt-2 mb-4 navbar-light">
            <a href="{{ url('') }}" class="text-center text-light-gray mb-4">
        ...
        <div class="col-12 text-center my-4">
            <h3>Login <br> Admin Online Course</h3>
        </div>
            ...
            <form action="{{ url('') }}" novalidate>
                <div class="form-group">
                    ...
                    <div class="input-group input-group-merge">
                        <input id="email_2" type="email" required="" class="form-control form-control-prepended" placeholder="admin@zethansa.com">
                ...
                <div class="form-group mb-1">
                    <a href="{{ url('') }}"><button class="btn btn-block btn-primary" type="submit">Login</button></a>
                </div>
